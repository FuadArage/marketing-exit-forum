...
import { UserContext } from "../Context";
import { toast } from "react-toastify";
import { FaUserCircle, FaTelegram } from "react-icons/fa";
  ...
  return (
    <section className={styles.header_container}>
      <header className={styles.header}>
        ...
        {/* === Mobile Register beside Logo === */}
        {!userData?.userid && (
          <Link to="/sign-up" className={styles.mobile_login_btn}>
            <button className={styles.sign_in_btn}>Register</button>
          </Link>
        )}
        ...
        <div className={styles.navbar}>
          ...
          >
            ...
            {userData?.userid ? (
              ...
              <Link to="/sign-up" className={styles.desktop_login}>
                <button className={styles.sign_in_btn}>SIGN IN</button>
              </Link>
            )}
          </nav>
